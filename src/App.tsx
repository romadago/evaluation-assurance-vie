// Fichier : src/App.tsx (Version pour le questionnaire PER)
...
// --- On importe la nouvelle configuration pour le PER ---
import { configPER } from './configurations/PER.js';
        ...
        {!quizStarted ? (
          <div className="text-center animate-fade-in">
            ...
            <p className="text-gray-300 mb-8 max-w-lg mx-auto">
              Répondez à nos questions pour évaluer vos connaissances sur le PER et préparer au mieux votre avenir.
            </p>
